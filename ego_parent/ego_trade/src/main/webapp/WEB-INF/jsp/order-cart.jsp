...
<form id="orderForm" class="hide" action="/order/create.html" method="post">
		...
		<input type="hidden" name="orderShipping.receiverState" value="湖北省"/>
		<input type="hidden" name="orderShipping.receiverCity" value="武汉市"/>
		<input type="hidden" name="orderShipping.receiverDistrict" value="江夏区"/>
		<input type="hidden" name="orderShipping.receiverAddress" value="武汉工程大学（流芳校区）"/>
   			...
   			<ul class="ui-switchable-panel-main" id="consignee-list">
				...
				<li class="ui-switchable-panel" id="consignee_index_137617472"
					...
					<div class="consignee-item item-selected"
						...
						<div class="user-name">
							<div class="fl">
								<strong limit="4">yanyue</strong>&nbsp;&nbsp;收
							</div>
							<div class="fr">18372879804</div>
							<div class="clr"></div>
						</div>
						<div class="mt10" limit="15">湖北省 武汉市 江夏区</div>
						<div class="adr-m" limit="30">武汉工程大学（流芳校区）</div>
						<div>100000</div>
